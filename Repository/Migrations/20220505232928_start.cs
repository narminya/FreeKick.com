    ...
    public partial class start : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OuterLeagues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OuterLeagues_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_OuterLeagues_OuterLeagueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamPlayer_Positions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameLineup_Status_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameScores_TeamPlayer_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "TeamPlayer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GamePlayerEvents_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GamePlayerEvents_GameLineup_GamePlayerId",
                        column: x => x.GamePlayerId,
                        principalTable: "GameLineup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerEvents_EventId",
                table: "GamePlayerEvents",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerEvents_GamePlayerId",
                table: "GamePlayerEvents",
                column: "GamePlayerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OuterLeagues_TagId",
                table: "OuterLeagues",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_Player_TagId",
                table: "Player",
                column: "TagId");
